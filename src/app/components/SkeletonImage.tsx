...
export const SkeletonImage = ({ className = "", ...props }: SkeletonImageProps) => {
      ...
      {inView && (
        <>
          ...
          <Image
            ...
            className={`transition-opacity duration-300 object-cover ${loaded ? "opacity-100" : "opacity-0"} ${className}`}
            loading="lazy"
          />
        </>
      )}
